...
export const DEFAULT_RENDER_OPTIONS: RenderOptions = {
  ...
  watermark: { enabled: false, url: null, text: '', position: 'bottom-right', opacity: 0.85, scale_pct: 7, margin_pct: 4 },
  overlay_text: { enabled: false, text: '', position: 'bottom-left', color: '#ffffff', size_pct: 4, margin_pct: 5, shadow: true },
